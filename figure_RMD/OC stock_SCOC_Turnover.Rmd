...
ana_text1 <- data.frame(
  label = c(NA,"Habitat p=0.0097"),
  Station = c("GC1","GS1"),
  x     = c(1, 2.5),
  y     = c(1, 1200000))
ana_text2 <- data.frame(
  label = c(NA,"Season p=0.9716"),
  Station = c("GC1","GS1"),
  x     = c(1, 2.5),
  y     = c(1, 1100000))
...
ana_text1 <- data.frame(
  label = c(NA,"Habitat p=0.7963"),
  Station = c("GC1","GS1"),
  x     = c(1, 1.8),
  y     = c(1, 120))
ana_text2 <- data.frame(
  label = c(NA,"Season p=0.7269"),
  Station = c("GC1","GS1"),
  x     = c(1, 1.8),
  y     = c(1, 115))
