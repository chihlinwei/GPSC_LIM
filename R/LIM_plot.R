...
")
GC1_graph%>%
  export_svg %>% charToRaw %>% rsvg_png("fig/GC1_graph.png")
...
")
GS1_graph%>%
  export_svg %>% charToRaw %>% rsvg_png("fig/GS1_graph.png")
library(png)
library(grid)
library(gridExtra)
library(ggplotify)
library(cowplot)
library(ggplot2)
GC <- readPNG('fig/GC1_graph.png')
GS <- readPNG('fig/GS1_graph.png')
...
p
ggsave('fig/f04.png',p,width=12,height=5)
