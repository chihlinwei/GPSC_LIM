...
name<-list("T.."=expression(Total~system~throughput~(mg~C~m^-2)),
           "TST"=expression(Total~system~throughflow~(mg~C~m^-2)),
           "TSTC"=expression(Total~system~cycled~throughflow~(mg~C~m^-2)),
